...
int main(void) {
    ...
    assert(!strcmp(rt_provider_for_capability("device.remote-access.observe"), "roottools.execd"));
    assert(!strcmp(rt_provider_for_capability("device.remote-access.configure"), "roottools.execd"));
