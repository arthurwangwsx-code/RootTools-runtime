...
def run_regression(
    ...
    require(status.get("daemonVersion") == "0.14.0", f"expected daemon 0.14.0, got {status}")
    ...
    require(still_alive.get("uid") == 0 and still_alive.get("daemonVersion") == "0.14.0", "daemon died with UI")
