...
def run_regression(
    ...
    require(status.get("daemonVersion") == "0.9.1", f"expected daemon 0.9.1, got {status}")
    ...
    require(still_alive.get("uid") == 0 and still_alive.get("daemonVersion") == "0.9.1", "daemon died with UI")
