...
static const RTProviderBinding kBindings[] = {
    ...
    {"device.remote-access.observe", "roottools.execd"},
    ...
    {"device.policy.read", "roottools.execd"},
    ...
    {"device.ui.tap", "roottools.execd"},
    {"device.ui.type", "roottools.execd"},
    {"device.ui.swipe", "roottools.execd"},
    ...
    {"device.remote-access.configure", "roottools.execd"},
